...
const roomNames: { [key: number]: string } = {
  2634263: 'Room Patience',      // Room 1 - Deluxe
  2509568: 'Room Regeneration',  // Room 2 - Deluxe
  2644078: 'Room Truth',         // Room 3 - Family
  2634338: 'Room Generosity',    // Room 3a - Standard
  2634343: 'Room Love',          // Room 3b - Standard
  2509563: 'Room Humility',      // Room 4 - Standard
  2509578: 'Room Honesty',       // Room 5 - Family
  2509573: 'Room Wisdom'         // Room 6 - Standard
};

// Map of room IDs to their base prices
const roomBasePrices: { [key: number]: number } = {
  2634263: 45, // Room Patience - Deluxe Room with AC
  2509568: 45, // Room Regeneration - Deluxe Room with AC
  2644078: 50, // Room Truth - Family Room
  2634338: 40, // Room Generosity - Standard Room
  2634343: 40, // Room Love - Standard Room
  2509563: 40, // Room Humility - Standard Room
  2509578: 50, // Room Honesty - Family Room
  2509573: 40  // Room Wisdom - Standard Room
};
