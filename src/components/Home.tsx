      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-buttons">
            ...
            <a 
              href="https://www.airbnb.com/users/profile/1466809336154918028?previous_page_name=PdpHomeMarketplace" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="hero-airbnb" 
              aria-label="Book on Airbnb"
            >
              Airbnb
            </a>
            <a 
              href="https://www.booking.com/hotel/gh/boko-boko-guesthouse.en-gb.html?label=mkt123sc-c749137d-ad5a-4bbe-bb7c-2984de006238&aid=355028&ucfs=1&arphpl=1" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="hero-booking" 
              aria-label="Book on Bookings.com"
            >
              Bookings.com
            </a>
          </div>
          ...
          <div className="rooms-grid">
            <div className="room-card">
              ...
              <div className="room-content">
                <h3>Standard Room</h3>
                <p>Our Standard Rooms (Room 3a, 3b, 4, and 6) come equipped with ensuite bathrooms, providing privacy and convenience. Enjoy a cozy and peaceful space with access to shared facilities. Starting at $40 per night.</p>
                <button className="book-now-btn" onClick={handleBookNow}>Book Now</button>
              </div>
            </div>
            <div className="room-card">
              ...
              <div className="room-content">
                ...
                <p>Our Deluxe Rooms (Room 1 and 2) feature natural materials, energy-efficient lighting, and thoughtful decor. Perfect for couples or solo travelers, these rooms include air conditioning for your comfort. Starting at $45 per night.</p>
                <button className="book-now-btn" onClick={handleBookNow}>Book Now</button>
              </div>
            </div>
            <div className="room-card">
              ...
              <div className="room-content">
                <h3>Family Room</h3>
                <p>For families seeking a spacious retreat, our Family Rooms (Room 3 and 5) offer ample accommodation with extra space for your loved ones to connect and unwind. Starting at $50 per night.</p>
                <button className="book-now-btn" onClick={handleBookNow}>Book Now</button>
              </div>
            </div>
          </div>
