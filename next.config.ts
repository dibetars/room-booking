...
const csp = [
  ...
  "frame-src 'self' https://js.paystack.co https://checkout.paystack.com https://*.calendly.com https://www.google.com https://maps.google.com https://www.openstreetmap.org",
  "object-src 'none'",
  "base-uri 'self'",
