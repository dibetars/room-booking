...
### 2. Home Component
- Hero section with video background and CTA buttons (Book Now, Airbnb, Booking.com)
...
- Specific room IDs and pricing:
  - Standard Rooms ($40):
    - Room Generosity (3a - 2634338)
    - Room Love (3b - 2634343)
    - Room Humility (4 - 2509563)
    - Room Wisdom (6 - 2509573)
  - Deluxe Rooms with AC ($45):
    - Room Patience (1 - 2634263)
    - Room Regeneration (2 - 2509568)
  - Family Rooms ($50):
    - Room Truth (3 - 2644078)
    - Room Honesty (5 - 2509578)
